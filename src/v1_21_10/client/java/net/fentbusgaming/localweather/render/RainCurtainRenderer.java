...
public class RainCurtainRenderer {
     ...
     *
     * {@code RenderLayer.getTranslucentMovingBlock()} is a textured block layer: its vertex format also wants
     ...
     * normal data.
     */
    private static final RenderLayer CURTAIN_RENDER_LAYER = RenderLayer.getDebugFilledBox();
